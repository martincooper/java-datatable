...
public class QuickSortTests {
    ...
    @Test
    public void testMultiQuickSortWithNullValues() {
        ...
        // Check Index Column values are as expected.
        assertTrue(view.get().row(0).getAs(Integer.class, "IndexCol") == 7);
        assertTrue(view.get().row(1).getAs(Integer.class, "IndexCol") == 5);
        assertTrue(view.get().row(2).getAs(Integer.class, "IndexCol") == 3);
        assertTrue(view.get().row(3).getAs(Integer.class, "IndexCol") == 1);
        assertTrue(view.get().row(4).getAs(Integer.class, "IndexCol") == 2);
        assertTrue(view.get().row(5).getAs(Integer.class, "IndexCol") == 4);
        assertTrue(view.get().row(6).getAs(Integer.class, "IndexCol") == 6);
    }
}
